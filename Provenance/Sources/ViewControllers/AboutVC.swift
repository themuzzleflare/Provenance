...
private extension AboutVC {
    private func configure() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(
            image: R.image.chevronLeftSlashChevronRight(),
            style: .plain,
            target: self,
...
extension AboutVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let topCell = tableView.dequeueReusableCell(
                withIdentifier: AboutTopTableViewCell.reuseIdentifier,
                for: indexPath
        ) as? AboutTopTableViewCell else {
            fatalError("Unable to dequeue reusable cell with identifier: \(AboutTopTableViewCell.reuseIdentifier)")
        }

        guard let sectionOneAttributeCell = tableView.dequeueReusableCell(
        ...
        let basicCell = tableView.dequeueReusableCell(
