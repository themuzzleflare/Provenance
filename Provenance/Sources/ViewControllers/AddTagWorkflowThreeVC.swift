                ...
                DispatchQueue.main.async {
                    ...
                    case .none:
                        let nb = GrowingNotificationBanner(
                            title: "Success",
                            subtitle: "\(tagIds) was added to \(transaction.attributes.transactionDescription).",
                            style: .success
                        )
                    ...
                    default:
                        ...
                        switch error {
                        case .transportError: navigationController?.popToRootViewController(animated: true)
...
extension AddTagWorkflowThreeVC: ASTableDataSource {
    func numberOfSections(in tableNode: ASTableNode) -> Int { return 3 }
    ...
    func tableNode(_ tableNode: ASTableNode, nodeBlockForRowAt indexPath: IndexPath) -> ASCellNodeBlock {
        let cell = ASTextCellNode(
            attributes: [
                NSAttributedString.Key.font: R.font.circularStdBook(size: UIFont.labelFontSize),
    ...
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        switch section {
        case 0: return "Adding \(tags.count == 1 ? "Tag" : "Tags")"
        case 1: return "To Transaction"
    ...
    func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        switch section {
        case 2: return "No more than 6 tags may be present on any single transaction. Duplicate tags are silently ignored."
        default: return nil
        }
    }
}
