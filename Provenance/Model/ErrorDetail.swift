...
func statusDetail(for statusCode: Int) -> (title: String, detail: String) {
    switch statusCode {
        ...
        case 201:
            return (title: "Successful response", detail: "A new resource was created successfully—Typically used with POST requests.")
        case 204:
        ...
        case 404:
            return (title: "Not found", detail: "Either the endpoint does not exist, or the requested resource does not exist.")
        case 422:
            return (title: "Invalid request", detail: "The request contains invalid data and was not processed.")
        case 429:
            return (title: "Too many requests", detail: "You have been rate limited—try later, ideally with exponential backoff.")
