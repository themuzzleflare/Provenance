...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if let shortcutItem = connectionOptions.shortcutItem { savedShortcutItem = shortcutItem }
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        if savedShortcutItem != nil { handleShortcutItem(shortcutItem: savedShortcutItem) }
    ...
    func sceneWillResignActive(_ scene: UIScene) {
        ...
        if savedShortcutItem != nil { savedShortcutItem = nil }
    }
}
    ...
    private func handleShortcutItem(shortcutItem: UIApplicationShortcutItem) -> Bool {
        ...
        if let tbc = window?.rootViewController as? TabBarController,
           let actionTypeValue = ShortcutType(rawValue: shortcutItem.type) {
            ...
            case .transactions: tbc.selectedIndex = 0
            case .accounts: tbc.selectedIndex = 1
            case .tags: tbc.selectedIndex = 2
            case .categories: tbc.selectedIndex = 3
            case .about: tbc.selectedIndex = 4
            }
        }
