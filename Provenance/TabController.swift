...
class TabController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let tabOne = UINavigationController(rootViewController: TransactionsViewController())
        ...
        let tabTwo = UINavigationController(rootViewController: AccountsViewController())
        ...
        let tabThree = UINavigationController(rootViewController: AllTagsViewController())
        ...
        let tabFour = UINavigationController(rootViewController: CategoriesViewController())
        ...
        let tabFive = UINavigationController(rootViewController: AboutViewController())
