...
extension AboutVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let topCell = tableView.dequeueReusableCell(withIdentifier: AboutTopTableViewCell.reuseIdentifier, for: indexPath) as? AboutTopTableViewCell else {
            fatalError("Unable to dequeue reusable cell with identifier: \(AboutTopTableViewCell.reuseIdentifier)")
        }

        guard let sectionOneAttributeCell = tableView.dequeueReusableCell(withIdentifier: AttributeTableViewCell.reuseIdentifier, for: indexPath) as? AttributeTableViewCell else {
